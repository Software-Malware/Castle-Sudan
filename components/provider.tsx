...
const mainnetid = 'https://eth-mainnet.alchemyapi.io/v2/oKxs-03sij-U_N0iOlrSsZFr29-IqbuF';
...
export const config = createConfig({
  ...
  storage: createStorage({
    ...
    transports: {
    [hardhat.id] : http(),
    [mainnet.id]: http('https://virtual.mainnet.eu.rpc.tenderly.co/5b9b3ca8-d8f4-454c-813c-3b0d0bebb72a'),
    [sepolia.id]: http(),
    [arbitrum.id]: http(),
    [base.id]: http(),
    [baseSepolia.id]: http(),
